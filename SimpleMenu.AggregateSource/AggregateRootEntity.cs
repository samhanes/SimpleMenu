...
{
    /// <summary>
    /// Base class for aggregate root entities with some infrastructure for tracking state changes.
    /// </summary>
    public abstract class AggregateRootEntity
    {
        ...
        /// <summary>
        /// Identifier of the aggregate root that will be used for persistence.  
        /// Typically, an aggregate root will implement a concretely-typed id property and reference it here.
        /// </summary>
        ...
        /// <summary>Initializes this instance using the specified events.</summary>
        ...
        /// <summary>Applies the specified event to this instance and invokes the associated state handler.</summary>
        ...
        /// <summary>Called before an event is applied, exposed as a point of interception.</summary>
        /// <param name="event">The event that will be applied.</param>
        protected virtual void BeforeApplyChange(object @event) { }

        /// <summary>Called after an event is applied, exposed as a point of interception.</summary>
        /// <param name="event">The event that will be applied.</param>
        ...
        /// <summary>Determines whether this instance has state changes.</summary>
        ...
        /// <summary>Gets the state changes applied to this instance.</summary>
        ...
        /// <summary>Clears the state changes.  Typically called after changes have been successfully persisted.</summary>
